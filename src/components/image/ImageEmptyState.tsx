...
export function ImageEmptyState() {
  return (
    <div className="relative z-0 flex min-h-0 flex-1 flex-col items-center justify-start overflow-y-auto px-4 pb-80 pt-6 sm:justify-center sm:px-6 sm:pb-48">
      <div className="flex items-center justify-center pt-2 pl-3">
      ...
      <div className="mt-3 max-w-md text-center sm:mt-5">
        ...
        <p className="mx-auto mt-2 max-w-sm text-[13px] leading-5 text-hf-muted sm:mt-2.5 sm:text-sm">
